# Generated by Django 5.2.7 on 2025-11-02 08:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, default='profile_img/profile_pic.png', null=True, upload_to='profile_img')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Student', 'Student'), ('Faculty', 'Faculty'), ('Administration', 'Administration'), ('Guest', 'Guest')], max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='backend_app.blog')),
            ],
            options={
                'ordering': ['-created_at'],
            },
